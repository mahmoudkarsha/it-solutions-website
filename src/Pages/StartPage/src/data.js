        ...
        features: {
                ...
                data: [
                        ...
                        },
                        {
                                ...
                                sub_header: 'Generate detailed reports tailored to your business requirements and Export data in various formats, including PDF, Excel, and CSV.',
                        },
                ],
        },
};
                ...
                data: [
                        {
                                ...
                                sub_header: 'Our React Native mobile apps offer seamless functionality on both iOS and Android platforms. With a single codebase, we ensure a consistent user experience across different devices, reducing development time and costs.',
                        },
                        {
                                header: 'Native-Like Performance',
                                sub_header: 'Experience the speed and responsiveness of native apps. React Native utilizes native components and APIs to deliver superior performance, ensuring your app runs smoothly and efficiently, handling even the most demanding tasks.',
                        },
                        {
                                header: 'Beautiful and Intuitive Design',
                                sub_header: 'Our apps feature rich, customizable UI components that create visually appealing and user-friendly interfaces. We prioritize design excellence to ensure that your app not only looks great but also provides an intuitive user experience.',
                        },
                        {
                                header: 'Reliable and Secure',
                                sub_header: 'Our apps are built with security in mind, employing best practices to protect user data and ensure app integrity. You can trust that your app will be reliable and secure, providing peace of mind for both you and your users.',
                        },
                ],
        },
};
                ...
                data: [
                        {
                                ...
                                sub_header: 'Our applications receive frequent updates to address potential vulnerabilities and enhance security measures continuously.',
                        },
                        {
                                header: 'Interactive Components',
                                sub_header: 'Utilizing frameworks like React, we create dynamic and engaging user interfaces that enhance user interaction and satisfaction.',
                        },
                        {
                                header: 'Customizable Themes',
                                sub_header: 'Users can personalize their experience with a range of themes and layouts, making the application feel tailored to their preferences.',
                        },
                        {
                                header: 'Attention to Detail',
                                sub_header: 'Every element, from icons to animations, is crafted with precision to ensure a cohesive and polished look.',
                        },
                ],
        },
};
                ...
                data: [
                        {
                                ...
                                sub_header: "Modern home automation systems are designed to work together seamlessly. Whether you're using devices from different manufacturers or expanding your system over time, our solutions ensure smooth integration and interoperability.",
                        },
                        {
                                header: 'Convenience and Control',
                                sub_header: 'Home automation allows you to control various aspects of your home with ease, using a smartphone, tablet, or voice commands. From lighting and climate control to security systems and appliances, you can manage your home environment effortlessly, no matter where you are.',
                        },
                        {
                                header: 'Future-Ready Technology',
                                sub_header: 'Investing in home automation prepares your home for the future. As technology continues to evolve, your smart home system can be easily updated and expanded to incorporate new devices and features, ensuring that your home remains at the cutting edge of innovation.',
                        },
                        {
                                header: 'Smart Appliances',
                                sub_header: 'Integrate your kitchen and household appliances into your smart home system for greater convenience and efficiency.',
                        },
                ],
        },
};
